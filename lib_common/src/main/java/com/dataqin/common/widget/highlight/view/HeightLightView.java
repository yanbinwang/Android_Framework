package com.dataqin.common.widget.highlight.view;
 ...
 */
public class HeightLightView extends FrameLayout {
    ...
    private List<HeightLight.ViewPosInfo> mViewRects;
    private HeightLight mHeightLight;
...
//    private boolean isBlur = true;
    ...
    private HeightLight.ViewPosInfo mViewPosInfo;//当前显示的高亮布局位置信息

    public HeightLightView(Context context, HeightLight heightLight, int maskColor, List<HeightLight.ViewPosInfo> viewRects, boolean isNext) {
        super(context);
        mHeightLight = heightLight;
...
//            mPaint.setMaskFilter(new BlurMaskFilter(DEFAULT_WIDTH_BLUR, BlurMaskFilter.Blur.SOLID));
    ...
    public void addViewForTip() {
        if (isNext) {
            ...
            if (mHeightLight != null) {
                mHeightLight.sendNextMessage();
            }

        } else {
            for (HeightLight.ViewPosInfo viewPosInfo : mViewRects) {
     ...
     */
    private void addViewForEveryTip(HeightLight.ViewPosInfo viewPosInfo) {
...
//            }
     ...
     */
    private void addViewEveryTipShape(HeightLight.ViewPosInfo viewPosInfo) {
    ...
    private void updateTipPos() {
        ...
        if (isNext) {
            ...
            for (int i = 0, n = getChildCount(); i < n; i++) {
                ...
                HeightLight.ViewPosInfo viewPosInfo = mViewRects.get(i);
    ...
    private LayoutParams buildTipLayoutParams(View view, HeightLight.ViewPosInfo viewPosInfo) {
...
//        }
     ...
     * @return 当前高亮提示布局信息
     */
    public HeightLight.ViewPosInfo getCurrentViewPosInfo() {
        return mViewPosInfo;
    }
