package com.ow.basemodule.utils.upload

import android.content.Context
import com.ow.basemodule.bean.UploadBean
import com.ow.basemodule.constant.RequestCode
import com.ow.basemodule.subscribe.BaseSubscribe
import com.ow.basemodule.utils.http.RxSubscribe
...
class UploadUtil(private val context: Context) {
    ...
    //上传图片监听
    fun setOnUploadImageListener(onUploadListener: OnUploadListener) {
