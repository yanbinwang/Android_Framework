...
import com.ow.basemodule.widget.dialog.callback.OnAppConfirmDialogListener;
import com.ow.basemodule.widget.dialog.callback.OnAppConfirmOrCancelDialogListener;
...
public class AppDialog {
    ...
    public static void show(Context context, String tipStr, String contentStr, String sureStr, String cancelStr, OnAppConfirmOrCancelDialogListener onAppConfirmOrCancelDialogListener) {
        ...
        LinearLayout dialogContainerLin = view.findViewById(R.id.dialog_container_lin);
        ...
        //标题
        TextView dialogTipTxt = myDialog.findViewById(R.id.dialog_tip_txt);
        //内容
        TextView dialogContentTxt = myDialog.findViewById(R.id.dialog_content_txt);
        //确定
        TextView dialogSureTxt = myDialog.findViewById(R.id.dialog_sure_txt);
        //取消
        TextView dialogCancelTxt = myDialog.findViewById(R.id.dialog_cancel_txt);
