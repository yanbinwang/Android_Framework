...
import com.ow.basemodule.widget.xrecyclerview.XRecyclerView
...
abstract class BasePresenter<T : BaseView> {
    ...
    protected fun doResponse(msg: String?): Boolean {
        ...
        if (TextUtils.isEmpty(msg)) {
            message = context!!.getString(R.string.response_err_txt)
        }
        if (!NetWorkUtil.isNetworkAvailable()) {
            view!!.showToast(context!!.getString(R.string.response_net_err_txt))
        } else {
