...
import com.dataqin.testnew.widget.AutoFitTextureView;
...
public class CameraController {
    ...
    private final Semaphore mCameraOpenCloseLock = new Semaphore(1);//一个信号量以防止应用程序在关闭相机之前退出。
    ...
    public void setFolderPath(String path) {
        ...
        if (!mFolder.exists()) {
            mFolder.mkdirs();
            LogUtil.d(TAG, "文件夹不存在去创建");
        } else {
            LogUtil.d(TAG, "文件夹已创建");
        }
    }
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        LogUtil.d(TAG, "setUpMediaRecorder: "+rotation);
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                LogUtil.d(TAG, "widthPixels: " + widthPixels + "____heightPixels:" + heightPixels);
                ...
                if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
                    ...
                    LogUtil.d(TAG, "横屏: "+"width:"+mPreviewSize.getWidth()+"____height:"+mPreviewSize.getHeight());
                } else {
                    // 竖屏
                    mTextureView.setAspectRatio(widthPixels, heightPixels);
                    LogUtil.d(TAG, "竖屏: "+"____height:"+mPreviewSize.getHeight()+"width:"+mPreviewSize.getWidth());
                }
