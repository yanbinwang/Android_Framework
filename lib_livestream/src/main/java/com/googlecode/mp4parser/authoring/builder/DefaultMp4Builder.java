...
public class DefaultMp4Builder implements Mp4Builder {
    ...
    private static final Logger LOG = Logger.getLogger(DefaultMp4Builder.class.getName());
    ...
    private MovieBox createMovieBox(Movie movie) {
        ...
        if (DateHelper.convert(mvhd.getCreationTime()) >= 1l << 32 || DateHelper.convert(mvhd.getModificationTime()) >= 1l << 32 || mvhd.getDuration() >= 1l << 32) {
            mvhd.setVersion(1);
        }
    ...
    private TrackBox createTrackBox(Track track, Movie movie) {
        ...
        if (DateHelper.convert(tkhd.getCreationTime()) >= 1l << 32 || DateHelper.convert(tkhd.getModificationTime()) >= 1l << 32 || tkhd.getDuration() >= 1l << 32) {
            tkhd.setVersion(1);
        }
