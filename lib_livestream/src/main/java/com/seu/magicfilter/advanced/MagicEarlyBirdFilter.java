...
public class MagicEarlyBirdFilter extends GPUImageFilter {
    ...
    private final int[] inputTextureHandles = {-1, -1, -1, -1, -1};
    private final int[] inputTextureUniformLocations = {-1, -1, -1, -1, -1};
    ...
    protected void onInit() {
        super.onInit();
        for (int i = 0; i < inputTextureUniformLocations.length; i++) inputTextureUniformLocations[i] = GLES20.glGetUniformLocation(getProgram(), "inputImageTexture" + (2 + i));
