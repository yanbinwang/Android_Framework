package com.dataqin.websocket.request;
...
public class RequestFactory {
    ...
    private static final Queue<ByteArrayRequest> BYTE_ARRAY_REQUEST_POOL = new ArrayDeque<>(POLL_SIZE);
    private static final Queue<ByteBufferRequest> BYTE_BUFFER_REQUEST_POOL = new ArrayDeque<>(POLL_SIZE);
    private static final Queue<StringRequest> STRING_REQUEST_POOL = new ArrayDeque<>(POLL_SIZE);
    private static final Queue<PingRequest> PING_REQUEST_POOL = new ArrayDeque<>(POLL_SIZE);
    private static final Queue<PongRequest> PONG_REQUEST_POOL = new ArrayDeque<>(POLL_SIZE);
    private static final Queue<FrameDataRequest> FRAME_DATA_REQUEST_POOL = new ArrayDeque<>(POLL_SIZE);
    private static final Queue<CollectionFrameDataRequest> COLLECTION_FRAME_REQUEST_POOL = new ArrayDeque<>(POLL_SIZE);
