...
import com.dataqin.websocket.request.RequestFactory;
    ...
    private SocketWrapperListener getSocketWrapperListener() {
        return new SocketWrapperListener() {
            ...
            public void onConnectFailed(Throwable e) {
                ...
                if (mReconnectManager != null && mReconnectManager.reconnecting()) {
            ...
            public void onSendDataError(Request request, int type, Throwable tr) {
                ...
                if (mSetting.processDataOnBackground()) {
                    mResponseProcessEngine.onSendDataError(errorResponse, mSetting.getResponseDispatcher(), mDelivery);
                } else {
            ...
            public void onMessage(Response message) {
                if (mSetting.processDataOnBackground()) {
                    mResponseProcessEngine.onMessageReceive(message, mSetting.getResponseDispatcher(), mDelivery);
                } else {
